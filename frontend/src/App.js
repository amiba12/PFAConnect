  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/projet"
          element={isAuthenticated ? <ProjetPage /> : <Navigate to="/login" />}
        />
        <Route
          path="/groupes"
          element={isAuthenticated ? <GroupePage /> : <Navigate to="/login" />}
        />
        <Route
          path="/rapports"
          element={isAuthenticated ? <RapportPage /> : <Navigate to="/login" />}
        />
        <Route
          path="/messages"
